...
public class ClassController {
    ...
    public String selectAll(HttpServletRequest request) throws Exception{
        ...
        List<ClassXX> listsList = iClassService.selectAll(pageInteger,limitInteger);
    ...
    public String SelectCount(HttpServletRequest request)    //查询班级class表中所有数据条数
    {
    ...
    public ClassXX selectById(HttpServletRequest request){
        String id = request.getParameter("id");
        Integer idInteger = Integer.valueOf(id);
        ClassXX cla = iClassService.selectById(idInteger);
        return cla;
    }
